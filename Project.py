        ...
        with var.container():
            ...
            with st.sidebar:
                ...
                with sidebar.container():
                    st.image("https://app.omnistock.io/uploads/logo/yktS4FqNbQGn3TychVaEzDIkHoiJa4Ei5HPSAIAy.png")
                    st.caption("")
                    st.caption("")
                    current_tab = on_hover_tabs(tabName=['Home','Login', 'Register', 'Admin','Help','About Us'], iconName=['home','account_circle','economy','dashboard','help_center','person'], styles = {'tabOptionsStyle': {':hover :hover': {'color': 'blue'}}}, key=st.session_state['key'], default_choice=0)
        ...
        with var.container():
            ...
            with st.sidebar:
                ...
                with sidebar.container():
                    ...
                    st.caption("")
                    st.caption("")
                    current_tab = on_hover_tabs(tabName=['View Users','Transactions', 'Logout'], iconName=['group','credit_card','logout'], styles = {'tabOptionsStyle': {':hover :hover': {'color': 'blue'}}}, key=st.session_state['key'], default_choice=0)
